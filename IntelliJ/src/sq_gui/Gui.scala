...
object Gui extends SimpleSwingApplication {
  ...
  def top = new MainFrame() {
    ...
    title = "Gui Explorer"
    //this.preferredSize = java.awt.Toolkit.getDefaultToolkit.getScreenSize()
    ...
    val remData = Action("Löschen") {
      //todo Ausgewähltes element erfragen, und dieses aus dem Datenbestand herauslöschen
    ...
    var searchInput = new TextField("ASDasdaSDASdsad") {
    ...
    var functionPanel = new FlowPanel() {
      ...
      //        FlowLayout.LEFT
      //TODO button possition setzen auf linksbündig
      contents += add
      contents += rem
    ...
    var box_right = new BoxPanel(Orientation.Vertical) {
      ...
      var oursize = java.awt.Toolkit.getDefaultToolkit.getScreenSize()

      val screenH = oursize.getHeight.toInt
      val screenW = 200
